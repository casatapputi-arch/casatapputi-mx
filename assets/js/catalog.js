...
const PRODUCT_META = {
  'esencia-miel':       { cat:'esencias', price:400,  priceLabel:'desde $400 MXN',    img:'assets/images/esencias-amber.webp',      desc:'Extraída por alambique de floración natural. Favorece dopamina y oxitocina; promueve relajación y concentración.', latin:'Apis mellifera',              usage:'Aromaterapia' },
  ...
  'perfume-solido':     { cat:'esencias', price:80,   priceLabel:'desde $80 MXN',     img:'assets/images/perfume-solido.webp',      desc:'Cera de abeja, aceite de oliva y aceites esenciales botánicos. Nutre la piel mientras perfuma. 18 aromas.',            latin:'Rosa damascena · Santalum', usage:'Fragancia personal' },
  'lagrimas-rosas':     { cat:'esencias', price:100,  priceLabel:'desde $100 MXN',    img:'assets/images/lagrimas-rosas.webp',      desc:'Resina sagrada para saumerios. Limpia el aire, crea un ambiente de calma y armonía.',                                   latin:'Boswellia sacra',            usage:'Saumerio' },
