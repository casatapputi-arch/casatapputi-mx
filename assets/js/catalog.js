...
const PRODUCT_META = {
  'esencia-miel':       { cat:'esencias', price:400,  priceLabel:'desde $400 MXN',     img:'assets/images/esencias-amber.webp',       desc:'Extraída por alambique de floración natural. Favorece la producción de dopamina y oxitocina; promueve relajación y concentración. Uso corporal o difusor.' },
  'esencias-naturales': { cat:'esencias', price:400,  priceLabel:'desde $400 MXN',     img:'assets/images/esencias-naturales.webp',   desc:'18 aromas por alambique: Violetas, Nardo, Mandarina, Menta, Rosas, Canela, Lavanda, Eucalipto, Romero, Jazmín, Sándalo, Geranio, Limón, Bergamota, Mirra, Pino, Tabaco, Lilas. Uso corporal o difusor.' },
  'perfume-solido':     { cat:'esencias', price:80,   priceLabel:'desde $80 MXN',      img:'assets/images/perfume-solido.webp',       desc:'Cera de abeja, aceite de oliva y aceites esenciales botánicos. Nutre la piel mientras perfuma. 18 aromas disponibles.' },
  'lagrimas-rosas':     { cat:'esencias', price:100,  priceLabel:'desde $100 MXN',     img:'assets/images/lagrimas-rosas.webp',       desc:'Resina sagrada para saumerios. Limpia el aire, crea un ambiente de calma y armonía.' },
  'oleo-masaje':        { cat:'corporal', price:150,  priceLabel:'desde $150 MXN',     img:'assets/images/oleo-masaje.webp',          desc:'Fusión de ingredientes naturales y esencias seleccionadas. Nutre la piel y ofrece beneficios emocionales.' },
  'roll-on':            { cat:'corporal', price:200,  priceLabel:'$200 MXN',           img:'assets/images/roll-on.webp',              desc:'Menta, Pino y Eucalipto. Menta despeja la mente; Pino equilibra las emociones; Eucalipto purifica y facilita la respiración profunda. 15 ml.' },
  'miel-melipona':      { cat:'corporal', price:350,  priceLabel:'$350 MXN',           img:'assets/images/miel-melipona.webp',        desc:'Recolectada por abejas sin aguijón. Tesoro sagrado ancestral de poderosas propiedades curativas.' },
  'friega-cannabis':    { cat:'corporal', price:90,   priceLabel:'desde $90 MXN',      img:'assets/images/friega-cannabis.webp',      desc:'Sinergia de cannabis, veneno de hormiga roja y plantas medicinales. Analgésico profundo y antiinflamatorio.' },
  'chilcuague':         { cat:'corporal', price:100,  priceLabel:'$100 MXN',           img:'assets/images/chilcuague.webp',           desc:'Spray oral de raíz medicinal. Acción antibacteriana y antiinflamatoria sobre encías, mucosas y tejidos orales. 30 ml.' },
  'jabones':            { cat:'corporal', price:90,   priceLabel:'$90 MXN / pz',       img:'assets/images/jabones-herbales.webp',     desc:'7 variedades con aceite de coco: Miel & Avena, Menta & Romero, Manzanilla & Bergamota, Manzana & Canela, Lavanda & Violeta, Rosas & Anís Estrella, Carbón Activado.' },
  'agua-rosas':         { cat:'facial',   price:150,  priceLabel:'$150 MXN',           img:'assets/images/agua-rosas.webp',           desc:'Tónico natural de pétalos frescos. Calma, hidrata y equilibra la piel. Sin alcohol ni químicos agresivos. 30 ml.' },
  'gel-rosas':          { cat:'facial',   price:150,  priceLabel:'$150 MXN',           img:'assets/images/gel-rosas.webp',            desc:'Hidratante con extracto de pétalos frescos. Textura ligera de rápida absorción. Propiedades antioxidantes. 100 ml.' },
  'gel-cafe':           { cat:'facial',   price:150,  priceLabel:'$150 MXN',           img:'assets/images/mascarilla-cafe.webp',      desc:'Tratamiento revitalizante. La cafeína estimula la circulación y despierta la piel. Tonifica, refresca y deja el rostro suave y luminoso. 30 ml.' },
  'pomada-calendula':   { cat:'facial',   price:100,  priceLabel:'desde $100 MXN',     img:'assets/images/pomada-calendula.webp',     desc:'Cera de abeja y lípido vegetal. Antiinflamatoria y cicatrizante para heridas menores, quemaduras leves e irritaciones.' },
  'pomada-cannabis':    { cat:'facial',   price:100,  priceLabel:'desde $100 MXN',     img:'assets/images/pomada-cannabis.webp',      desc:'Sinergia de cannabis, veneno de hormiga roja y plantas medicinales. Para dolores musculares y articulares.' },
  'salsa-matcha':       { cat:'cocina',   price:200,  priceLabel:'$200 MXN / pz',      img:'assets/images/salsa-matcha.webp',         desc:'4 variedades con semillas, chiles secos e ingredientes de temporada: Chapulines, Frutos Rojos, Ajo y Habanero.' },
  'tisanas':            { cat:'cocina',   price:1300, priceLabel:'$1,300 MXN / kg',    img:'assets/images/t13-01264.webp',            desc:'Mezclas con ingredientes naturales y orgánicos del jardín medicinal de Huerto Roma Verde. Sin aditivos. 1 kg.' },
  'leche-dorada':       { cat:'cocina',   price:0,    priceLabel:'Consultar precio',   img:'assets/images/leche-dorada.webp',         desc:'Mezcla ancestral de cúrcuma, pimienta negra, clavo y especias. Potente antiinflamatoria y reconfortante.' },
  'terrarios':          { cat:'hogar',    price:0,    priceLabel:'Medidas personalizadas', img:'assets/images/terrarios-vidrio.webp',  desc:'Piezas decorativas de vidrio en medidas personalizadas: candeleros, joyeros, aparadores y mostradores.' },
  'talabarteria':       { cat:'estilo',   price:0,    priceLabel:'Piezas personalizadas',  img:'assets/images/talabarteria.webp',      desc:'Piel reciclada transformada en piezas elegantes y funcionales: cinturones, pulseras, carteras, mochilas.' }
};
